...
class Services {
    ...
    static let WEATHER_DETAIL_URL:String = "https://samples.openweathermap.org/data/2.5/forecast?id="
    static let WEATHER_IAMGE_URL:String = "http://openweathermap.org/img/wn/"
